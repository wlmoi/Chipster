...
<img src="assets/verilog_workflow_diagram.png" alt="Verilog Workflow Diagram" width="100%">
...
> **[Watch the Standard Cell Generator Demo (Click to Play)](assets/std_cells_gen_demo.mp4)**
> *(Note: For the best experience, we recommend converting this video to an animated GIF for automatic playback in the README.)*
